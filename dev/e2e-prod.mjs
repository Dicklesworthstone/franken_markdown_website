...
await reader.goto("https://franken-markdown.com/" + shareHash, { waitUntil: "networkidle" });
...
await deep.goto(`https://franken-markdown.com/#fmt=pdf&doc=${docParam}`, { waitUntil: "networkidle" });
...
await mobile.goto("https://franken-markdown.com/", { waitUntil: "networkidle" });
